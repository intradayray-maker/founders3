  ...
  return (
    <section className="py-2 px-6 max-w-6xl mx-auto">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
        Why AI‑Generated Ads Work Better
      </h2>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">

        <div className="bg-card border border-border rounded-xl p-8 space-y-4">
          <h3 className="text-2xl md:text-[22px] font-semibold bg-gradient-to-r from-emerald-400 to-purple-500 bg-clip-text text-transparent">
