import HeroStupid from "@/components/stupidtools/HeroStupid"
import WhyStupidWorks from "@/components/stupidtools/WhyStupidWorks"
import PricingStupid from "@/components/stupidtools/PricingStupid"
import FAQStupid from "@/components/stupidtools/FAQStupid"
...
export default function StupidToolsPage() {
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(139,92,246,0.18),_transparent_32%),linear-gradient(180deg,_#0a0a0a_0%,_#050505_100%)] text-text">
